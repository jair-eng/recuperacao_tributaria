...
from app.domain.fiscal.catalogo.catalogo_fiscal import CatalogoFiscal
from app.domain.fiscal.catalogo.semantica_operacao import classificar_operacao_fiscal
...
def classificar_item_fiscal(
    *,
    catalogo: CatalogoFiscal,
    meta: Dict[str, Any],
) -> dict:
    return {
        "operacao": classificar_operacao_fiscal(meta, catalogo),
        "produto": classificar_produto_fiscal(meta, catalogo),
    }