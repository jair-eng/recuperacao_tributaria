...
from app.Legacy.fiscal.constants import DOM_GERAL, DOMINIOS_VALIDOS
from app.Legacy.fiscal.dto import RegistroFiscalDTO
from app.Legacy.fiscal.regras.Diagnostico.insumos.lc192_helpers import consolidar_achados_comb_lc192_v1
from app.db.models.efd_versao import EfdVersao
from app.db.models.efd_arquivo import EfdArquivo
from app.Legacy.fiscal.scanners.c100_entrada import montar_c100_entrada_relevante_agg
from app.Legacy.fiscal.ent_cat_fiscal import carregar_catalogo_fiscal
from app.Legacy.fiscal.scanners.exportacao import montar_c170_export_agg, \
    montar_c170_ind_torrado_agg, montar_c170_insumo_agg, montar_c170_saida_agg
from app.Legacy.fiscal.scanners.scanner_helpers import key_apontamento, norm_codigo, norm_prioridade, prioridade_por_impacto, \
    safe_float, consolidar_achados_cfop_sem_credito_v1
from app.Legacy.fiscal.scanners.util_scan import aplicar_contexto
from app.Legacy.fiscal.varredura import executar_varredura
from app.Legacy.fiscal.scanners.exportacao import montar_meta_fiscal
...
from app.Legacy.fiscal.contexto import set_fiscal_context
import logging
