...
from app.fiscal.regras.Diagnostico.insumos.Transp_combustivel_semC170 import RegraTranspCombustivelSemC170V1
from app.fiscal.regras.Diagnostico.insumos.insumos_cafe import RegraC170InsumosCafeV1
from app.fiscal.regras.Diagnostico.insumos.insumos_transportadora import RegraC170InsumosTransportadoraV1, \
    RegraC170CombustivelTransportadoraV1
from app.fiscal.regras.Diagnostico.insumos.transp_combustivel_semC100 import RegraTranspCombustivelSemC100V1
from app.fiscal.regras.Diagnostico.regra_c170_cfop_sem_credito_v1 import RegraC170CfopSemCreditoV1
from app.fiscal.regras.Diagnostico.regra_comb_lc192_v1 import RegraCombLC192V1
from app.fiscal.regras.Diagnostico.regra_contrib_sem_c100_v1 import RegraContribSemC100V1
from app.fiscal.regras.Diagnostico.regra_contrib_sem_c170_v1 import RegraContribSemC170V1
from app.fiscal.regras.Diagnostico.insumos.regra_emb_insumo_v1 import RegraEmbalagemInsumoV1
from app.fiscal.regras.Diagnostico.regra_exportacao import RegraExportacaoRessarcimentoV1
from app.fiscal.regras.Diagnostico.insumos.regra_f600_insumos import RegraF600Insumos
...
from app.fiscal.regras.Diagnostico.insumos.regra_limp_insuV1 import RegraLimpezaInsumoV1
...
from app.fiscal.regras.Diagnostico.regra_posto_credito_normal import RegraPostoCreditoNormalV1
...
from app.fiscal.constants import DOM_AGRO, DOM_CAFE, DOM_SUP, DOM_GERAL, DOMINIOS_VALIDOS, DOM_TRANSP, DOM_POSTO, \
    DOM_REVENDA_GAS
from app.fiscal.regras.Diagnostico.regra_tranp_credito_pres import RegraTranspCredPresumidoNaoAproveitadoV1
