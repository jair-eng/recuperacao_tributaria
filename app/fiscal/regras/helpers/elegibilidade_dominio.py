...
from app.fiscal.constants import DOM_GERAL, DOM_CAFE, DOM_AGRO, DOM_TRANSP, DOM_POSTO, DOM_REVENDA_GAS
...
from app.fiscal.settings_fiscais import CFOPS_ELEGIVEIS, CFOPS_TRANSP_SUBCONTRATACAO, CFOPS_TRANSP_IMOBILIZADO, \
    CFOPS_TRANSP_COMBUSTIVEL, CFOPS_TRANSP_PECAS_OPERACAO, CFOPS_TRANSP_BLOCO_C, CFOPS_POSTO_COMBUSTIVEL, \
    CFOPS_REVENDA_GAS
