...
from app.fiscal.settings_fiscais import CSTS_NAO_CREDITAVEIS
from app.fiscal.constants import DOMINIOS_LC192, DOM_REVENDA_GAS
from app.fiscal.contexto import get_fiscal_db, get_fiscal_context
